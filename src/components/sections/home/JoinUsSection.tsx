    ...
    >
      ...
      <div className="relative z-10 max-w-[1500px] mx-auto px-6 md:px-10">
        ...
        >
          ...
          <TransitionLink
            href="/recruit"
            className="group inline-flex items-center gap-3 bg-white px-6 py-3 rounded-full text-sm font-medium text-black hover:bg-gray-50 transition-colors shadow-sm"
          >
            <span>See More</span>
