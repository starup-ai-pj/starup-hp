...
export default async function NewsSection({ locale }: { locale: string }) {
  const t = await getTranslations({ locale, namespace: 'sections.home.news' })
    ...
    <section className="relative bg-white py-20 md:py-32">
      <div className="max-w-[1500px] mx-auto px-6 md:px-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12 md:mb-20 border-b border-gray-200 pb-8 md:pb-10">
          <div>
            <span className="text-xs text-gray-500 uppercase tracking-[0.3em] mb-3 block">{t('eyebrow')}</span>
