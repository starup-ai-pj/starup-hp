...
// デフォルト画像パス
const DEFAULT_MEMBER_IMAGE = '/images/member/default-member.png'

// 画像を返す関数（画像が指定されていない場合はデフォルトを使用）
function getMemberImage(customImage?: string): string {
  return customImage || DEFAULT_MEMBER_IMAGE
}
        ...
        <div className="max-w-[1500px] mx-auto px-4">
          ...
          <div className="block lg:hidden space-y-6">
            ...
            <div>
              ...
              {member.englishName && (
                <p className="text-lg text-gray-500 mt-2">{member.englishName}</p>
              )}
            </div>
        ...
        <div className="max-w-[1500px] mx-auto px-4">
          ...
          <div className="block lg:hidden">
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              ...
              <ShareButtons title={`${member.name} - ${member.position}`} variant="horizontal" />
            </div>
          </div>
          ...
          <div className="hidden lg:grid grid-cols-12 gap-8">
            ...
            <div className="col-span-8 border-r border-gray-700 pr-8">
              <div>
                <h3 className="text-2xl font-medium text-gray-900 mb-6">Profile</h3>
            ...
            <div className="col-span-2">
              <div className="sticky top-8">
                ...
                <div>
                  <h4 className="text-sm font-medium text-gray-900 mb-4">Share</h4>
                  <ShareButtons title={`${member.name} - ${member.position}`} variant="vertical" />
                </div>
              </div>
            </div>
          </div>
