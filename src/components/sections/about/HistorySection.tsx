...
const historyData: HistoryEvent[] = [
  {
    year: '2023',
    month: '11',
    title: '株式会社STAR UP 設立',
    description: '京都市上京区にて創業',
  ...
  },
  {
    ...
    month: '01',
    title: 'AI共同開発事業を開始',
    description: '製造業・建設業向けのAIソリューション提供を本格化',
    image: '/images/tech-cards/chuttersnap-kyCNGGKCvyw-unsplash.jpg',
  },
  {
    year: '2024',
    month: '04',
    title: 'ARCHAIVE β版リリース',
    description: '製造業向けAI SaaSプロダクトの提供を開始',
  ...
  },
  {
    ...
    month: '07',
    title: 'SendAI リリース',
    description: 'AI活用の業務効率化ソリューションを展開',
  ...
  },
  {
    ...
    month: '10',
    title: 'プレシリーズA資金調達',
    image: '/images/tech-cards/cosmin-georgian-gd3ysFyrsTQ-unsplash.jpg',
  },
  {
    year: '2025',
    month: '01',
    title: '有料職業紹介事業 認可取得',
    description: '認可番号：26-ユ-300728',
    image: '/images/tech-cards/jezael-melgoza-layMbSJ3YOE-unsplash.jpg',
  },
  {
    year: '2025',
    month: '04',
    title: '正社員10名体制へ拡大',
    image: '/images/recruit/office-1.jpg',
  },
]
